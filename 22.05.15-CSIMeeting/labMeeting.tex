...
\begin{frame}[plain]
    ...
    \textbf{Mixture Gaussian pdf:}\\
    Key Assumption:\\
    \begin{itemize}
        \item ChIP-seq peaks are drawn from a finite set of gaussian distributions.
        \item ChIPseq peaks are fit with gaussian mixture models, with mixing $\lambda$ parameter.
        \item Each gaussian corresponds to a cluster of peaks with $\mu$ and $\sigma$ parameters.
    \end{itemize}
    \vspace{0.1in}
...
\begin{frame}[plain]
    ...
    \tikzstyle{block} = [rectangle, draw, fill=blue!80!black,opacity=0.5, 
    ...
    \begin{tikzpicture}[node distance = 2cm, auto]
        % Place nodes
        \node [block] (comp) {Component Calls: MM};
        \node [block, left of=comp, node distance=3cm, fill=green!80,opacity=0.5] (peak) {Peak Calls: MACS \& jaHMM};
        \node [block, left of=peak, node distance=3cm, fill=green!80,opacity=0.5] (input) {Input: ChIP (*.fastq)};
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=0.4\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_Cebpa_poissonModel.pdf}
        \includegraphics[width=0.4\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_Cebpa_negBinomModel.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth, height=0.7\textwidth]{/home/ricky/Rlim/ChromatinConformation/PeakCalls/CebpE/Output/KoefflerLab_BM_ChIPseq_CebpE_300_Rjahmm.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{tikzpicture}[node distance=2cm, auto]
        \node [blocktext] () {Can we model ChIPseq Peaks using components of MMs?};
    \end{tikzpicture}
...
\begin{frame}
    \frametitle{Input: ChIP-seq of Cebp$\epsilon$ from Koeffler-BM}
    \begin{figure}
        \includegraphics[width=0.8\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_CountChipSeqPeaks.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}                                                                                                                        
    ...
    \begin{figure}
        \includegraphics[width=0.8\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_CountChipSeqPeaks_log.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}                                                                                                                        
    ...
    \begin{figure}
        \includegraphics[width=0.4\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_log_qqplot.pdf}
        \includegraphics[width=0.4\textwidth, height=0.4\textwidth]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_qqplot.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    \frametitle{GMM-ModelAssessment: Overfit\footnotemark[1]}
    \begin{figure}[H]
        \centering
...
\begin{frame}[plain]
    ...
    \begin{tikzpicture}[node distance = 2cm, auto]
        % Place nodes
        \node [block] (comp) {Component Calls: GMM};
        \node [block, left of=comp, node distance=3cm, fill=green!80,opacity=0.5] (peak) {Peak Calls: MACS (*.xls)};
        \node [block, left of=peak, node distance=3cm, fill=green!80,opacity=0.5] (input) {Input: ChIP (*.fastq)};
        \node [block, below of=identify, fill=red!80] (assess) {Model Assessment};
        \node [block, right of=assess, node distance=3cm] (update) {Model Update};
        \node [decision, below of=assess] (decide) {Can we identify direct and indirect bindings?};
        \node [block, left of=decide, node distance=5cm] (stop) {stop};
...
\begin{frame}
    \begin{tikzpicture}[node distance=2cm, auto]
        \node [blocktext] () {Motif Calls using Centdist};
    \end{tikzpicture}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=1\textwidth, height=0.6\textwidth]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group1_compSorted3/CENTDIST_Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group1_compSorted3_page1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=1\textwidth, height=0.6\textwidth]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group2_compSorted3/CENTDIST_Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group2_compSorted3_page1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=1\textwidth, height=0.6\textwidth]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group3_compSorted3/CENTDIST_Koeffler_BM_CebpE_GMM_ModelAssignment_log_300_group3_compSorted3_page1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=1\textwidth, height=0.6\textwidth]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_300_compSorted3_dist3kb_direct/CENTDIST_Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_300_compSorted3_dist3kb_direct_page1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{figure}
        \includegraphics[width=1\textwidth, height=0.6\textwidth]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_300_compSorted3_dist3kb_indirect/CENTDIST_Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_300_compSorted3_dist3kb_indirect_page1.pdf}
    \end{figure}
\end{frame}
