...
\section{Summary and Future}
    ...
    \begin{frame}
        ...
        \begin{itemize}[<+->]
            \item Dry-lab work
                \begin{itemize}
                    \item ChIPseq signals normalization mainly on GC and mappability
                    \item Motif validation with other methods
                    \item Method tested using other \textbf{high-quality} ChIPseq
                    \item Peak clusters validated with other methods, such as ChIA-PET, and 5c
                \end{itemize}
            \item Wet-lab work
                \begin{itemize}
                    \item Peak clusters validation by 3C and ChIP
                \end{itemize}
        \end{itemize}
    \end{frame} 
